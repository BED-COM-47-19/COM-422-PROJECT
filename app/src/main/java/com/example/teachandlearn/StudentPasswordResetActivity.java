...
public class StudentPasswordResetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(StudentPasswordResetActivity.this, "Code sent to your email: " + code, Toast.LENGTH_SHORT).show();
            }
