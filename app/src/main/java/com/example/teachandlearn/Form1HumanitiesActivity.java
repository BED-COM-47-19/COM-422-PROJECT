...
public class Form1HumanitiesActivity extends AppCompatActivity {
    ...
    private void showToast(String message) {
        Toast.makeText(Form1HumanitiesActivity.this, message, Toast.LENGTH_SHORT).show();
    }

    // Method to start Form1ViewContentActivity
    private void startActivityForContent() {
        Intent intent = new Intent(Form1HumanitiesActivity.this, Form1ViewContentActivity.class);
