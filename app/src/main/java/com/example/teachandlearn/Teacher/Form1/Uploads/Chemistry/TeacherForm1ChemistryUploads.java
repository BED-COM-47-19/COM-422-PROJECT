package com.example.teachandlearn.Teacher.Form1.Uploads.Chemistry;
...
public class TeacherForm1ChemistryUploads extends AppCompatActivity {
    ...
    private static final String TAG = "TeacherForm1ChemistryUploads";
        ...
        if (resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            switch (requestCode) {
                ...
                case REQUEST_PICK_QUESTION:
                    uploadFile(selectedFileUri, "/form1/sciences/chemistry/quizzes_and_questions/", "questions", new String[]{"pdf", "docx", "pptx"}, "No restriction on question formats.");
                    break;
                default:
