package com.example.teachandlearn.Teacher.Form1.Uploads.English;
...
public class TeacherForm1EnglishUploads extends AppCompatActivity {
    ...
    private static final String TAG = "TeacherForm1EnglishUploads";
        ...
        if (resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            switch (requestCode) {
                ...
                case REQUEST_PICK_QUESTION:
                    uploadFile(selectedFileUri, "/form1/languages/english/quizzes_and_questions/", "questions", new String[]{"pdf", "docx", "pptx"}, "No restriction on question formats.");
                    break;
                default:
