...
package com.example.teachandlearn.Teacher.Form2.Uploads.Physics;
...
public class TeacherForm2PhysicsUploads extends AppCompatActivity {
        ...
        if (resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            switch (requestCode) {
                ...
                case REQUEST_PICK_QUESTION:
                    uploadFile(selectedFileUri, "/form2/sciences/physics/quizzes_and_questions/", "questions", new String[]{"pdf", "docx", "pptx"}, "No restriction on question formats.");
                    break;
                default:
