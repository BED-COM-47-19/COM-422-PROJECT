...
package com.example.teachandlearn.Teacher.Form3.Uploads.Life_Skills;
...
public class TeacherForm3Life_SkillsUploads extends AppCompatActivity {
        ...
        if (resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            switch (requestCode) {
                ...
                case REQUEST_PICK_QUESTION:
                    uploadFile(selectedFileUri, "/form3/humanities/life_skills/quizzes_and_questions/", "questions", new String[]{"pdf", "docx", "pptx"}, "No restriction on question formats.");
                    break;
                default:
