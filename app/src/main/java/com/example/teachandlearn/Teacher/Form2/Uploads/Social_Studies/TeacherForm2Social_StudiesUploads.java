...
package com.example.teachandlearn.Teacher.Form2.Uploads.Social_Studies;
...
public class TeacherForm2Social_StudiesUploads extends AppCompatActivity {
        ...
        if (resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            switch (requestCode) {
                ...
                case REQUEST_PICK_QUESTION:
                    uploadFile(selectedFileUri, "/form2/humanities/social_studies/quizzes_and_questions/", "questions", new String[]{"pdf", "docx", "pptx"}, "No restriction on question formats.");
                    break;
                default:
