...
package com.example.teachandlearn.Teacher.Form4.Uploads.Bible_Knowledge;
...
public class TeacherForm4Bible_KnowledgeUploads extends AppCompatActivity {
        ...
        if (resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            switch (requestCode) {
                ...
                case REQUEST_PICK_QUESTION:
                    uploadFile(selectedFileUri, "/form4/humanities/bible_knowledge/quizzes_and_questions/", "questions", new String[]{"pdf", "docx", "pptx"}, "No restriction on question formats.");
                    break;
                default:
