...
package com.example.teachandlearn.Teacher.Form3.Uploads.Biology;
...
public class TeacherForm3BiologyUploads extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            case REQUEST_PICK_QUESTION:
                uploadFile(selectedFileUri, "/form3/sciences/biology/quizzes_and_questions/", "questions", new String[]{"pdf", "docx", "pptx"}, "No restriction on question formats.");
                break;
            default:
