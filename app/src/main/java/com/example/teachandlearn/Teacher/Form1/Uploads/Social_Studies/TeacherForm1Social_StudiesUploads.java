package com.example.teachandlearn.Teacher.Form1.Uploads.Social_Studies;
...
public class TeacherForm1Social_StudiesUploads extends AppCompatActivity {
    ...
    private static final String TAG = "TeacherForm1Social"; // Changed TAG for clarity
        ...
        if (resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            switch (requestCode) {
                ...
                case REQUEST_PICK_VIDEO:
                    uploadFile(selectedFileUri, "/form1/humanities/social_studies/videos/", "videos", new String[]{"mp4", "avi", "mkv", "wmv", "mov"}, "Please select a video file.");
                    break;
                case REQUEST_PICK_QUESTION:
                    uploadFile(selectedFileUri, "/form1/humanities/social_studies/quizzes_and_questions/", "questions", new String[]{"pdf", "docx", "pptx"}, "No restriction on question formats.");
                    break;
                default:
    ...
    private void uploadFile(Uri fileUri, String storagePath, String firestoreCollection, String[] allowedExtensions, String errorMessage) {
        if (fileUri != null) {
            ...
            String fileName = getFileName(fileUri); // Get the original file name
    ...
    private String getFileName(Uri uri) {
        ...
        if (result == null) {
            result = Objects.requireNonNull(uri.getPath()).substring(uri.getPath().lastIndexOf('/') + 1);
        }
        return result;
    }
