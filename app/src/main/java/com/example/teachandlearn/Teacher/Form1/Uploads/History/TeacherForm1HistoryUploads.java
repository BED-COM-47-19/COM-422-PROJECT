package com.example.teachandlearn.Teacher.Form1.Uploads.History;
...
public class TeacherForm1HistoryUploads extends AppCompatActivity {
    ...
    private static final String TAG = "TeacherForm1HistoryUploads";
        ...
        if (resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            switch (requestCode) {
                ...
                case REQUEST_PICK_QUESTION:
                    uploadFile(selectedFileUri, "/form1/humanities/history/quizzes_and_questions/", "questions", new String[]{"pdf", "docx", "pptx"}, "No restriction on question formats.");
                    break;
                default:
