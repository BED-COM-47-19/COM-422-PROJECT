...
public class TeacherForm1Life_SkillsUploads extends AppCompatActivity {
    ...
    private static final String TAG = "TeacherForm1LifeSkills";
        ...
        if (resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            switch (requestCode) {
                ...
                case REQUEST_PICK_VIDEO:
                    uploadFile(selectedFileUri, "/form1/humanities/life_skills/videos/", "videos", new String[]{"mp4", "avi", "mkv", "wmv", "mov"}, "Please select a Video file.");
                    break;
