...
package com.example.teachandlearn.Teacher.Form3.Uploads.Agriculture;
...
public class TeacherForm3AgricultureUploads extends AppCompatActivity {
        ...
        if (resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            switch (requestCode) {
                ...
                case REQUEST_PICK_QUESTION:
                    uploadFile(selectedFileUri, "/form3/sciences/agriculture/quizzes_and_questions/", "questions", new String[]{"pdf", "docx", "pptx"}, "No restriction on question formats.");
                    break;
                default:
