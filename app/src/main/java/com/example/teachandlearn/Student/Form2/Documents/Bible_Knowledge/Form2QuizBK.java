...
public class Form2QuizBK extends AppCompatActivity {

    private TextView questionTextView;
    private RadioButton optionARadioButton, optionBRadioButton, optionCRadioButton, optionDRadioButton;
    private ProgressBar questionProgressBar;
    private List<Form2QuestionBK> questions;
    ...
    private List<Form2QuestionBK> loadQuestions() {


        List<Form2QuestionBK> questions = new ArrayList<>();
        questions.add(new Form2QuestionBK("What is the capital of France?", "Lilongwe", "Paris", "Mzuzu", "Dowa", "Paris"));
        questions.add(new Form2QuestionBK("What is 2 + 2?", "1", "5", "3", "4", "4"));
        questions.add(new Form2QuestionBK("What is the color of the sky?", "Sky Black", "Sky Green", "Sky White", "Sky Blue", "Sky Blue"));
        questions.add(new Form2QuestionBK("What is the capital of Spain?", "Barcelona", "London", "Madrid", "Espana", "Madrid"));
    ...
    private void displayQuestion() {
        ...
        if (currentQuestionIndex < questions.size()) {
            ...
            Form2QuestionBK currentQuestion = questions.get(currentQuestionIndex);
