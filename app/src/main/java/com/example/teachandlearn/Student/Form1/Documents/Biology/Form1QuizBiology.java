...
public class Form1QuizBiology extends AppCompatActivity {
    ...
    private List<Form1QuestionBiology> loadQuestions() {
        ...
        questions.add(new Form1QuestionBiology("What is the capital of France?", "Lilongwe", "Paris", "Mzuzu", "Dowa", "Paris"));
        questions.add(new Form1QuestionBiology("What is 2 + 2?", "1", "5", "3", "4", "4"));
        questions.add(new Form1QuestionBiology("What is the color of the sky?", "Sky Black", "Sky Green", "Sky White", "Sky Blue", "Sky Blue"));
        questions.add(new Form1QuestionBiology("What is the capital of Spain?", "Barcelona", "London", "Madrid", "Espana", "Madrid"));
