    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonPDF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Form3StudentViewContent.this, PDF.class);
        ...
        buttonAudio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Form3StudentViewContent.this, Audio.class);
                startActivity(intent);
            }
        });
        ...
        buttonVideos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Form3StudentViewContent.this, Vedio.class);
                startActivity(intent);
            }
        });
        ...
        buttonQuestions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Form3StudentViewContent.this, QuizzesAndQuestions.class);
                startActivity(intent);
            }
        });
    }
