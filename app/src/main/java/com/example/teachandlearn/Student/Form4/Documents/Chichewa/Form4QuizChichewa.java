...
public class Form4QuizChichewa extends AppCompatActivity {

    private TextView questionTextView;
    private RadioButton optionARadioButton, optionBRadioButton, optionCRadioButton, optionDRadioButton;
    private ProgressBar questionProgressBar;
    private List<Form4QuestionChichewa> questions;
    ...
    private List<Form4QuestionChichewa> loadQuestions() {


        List<Form4QuestionChichewa> questions = new ArrayList<>();
    ...
    private void displayQuestion() {
        ...
        if (currentQuestionIndex < questions.size()) {
            ...
            Form4QuestionChichewa currentQuestion = questions.get(currentQuestionIndex);
