...
public class Form2QuizzesAndQuestionsChichewa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form2QuizzesAndQuestionsChichewa.this, Form2PDFViewerChichewa.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form2QuizzesAndQuestionsChichewa.this, Form2QuizChichewa.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form2/languages/chichewa/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form2QuizzesAndQuestionsChichewa.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
