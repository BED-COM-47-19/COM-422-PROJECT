...
public class Form1QuizzesAndQuestionsBible_Knowledge extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form1QuizzesAndQuestionsBible_Knowledge.this, Form1PDFViewerBible_Knowledge.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form1QuizzesAndQuestionsBible_Knowledge.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
