...
public class Form3Quiz extends AppCompatActivity {
    ...
    private List<Form3Question> loadQuestions() {
        ...
        questions.add(new Form3Question("What is the difference between an element and a compound?",
        ...
        questions.add(new Form3Question("Explain the concept of a chemical reaction.",
        ...
        questions.add(new Form3Question("What is the law of conservation of mass?",
        ...
        questions.add(new Form3Question("What are isotopes?",
        ...
        questions.add(new Form3Question("Describe the properties of acids.",
        ...
        questions.add(new Form3Question("Explain the difference between exothermic and endothermic reactions.",
        ...
        questions.add(new Form3Question("What is electrolysis?",
        ...
        questions.add(new Form3Question("Discuss the role of catalysts in chemical reactions.",
        ...
        questions.add(new Form3Question("Explain the concept of a chemical bond.",
        ...
        questions.add(new Form3Question("Describe the structure and properties of diamond and graphite.",
