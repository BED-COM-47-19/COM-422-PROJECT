...
public class Form2QuizzesAndQuestionsBiology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form2QuizzesAndQuestionsBiology.this, Form2PDFViewerBiology.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form2QuizzesAndQuestionsBiology.this, Form2QuizBiology.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form2/sciences/biology/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form2QuizzesAndQuestionsBiology.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
