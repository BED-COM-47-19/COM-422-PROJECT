    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonPDF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Form1StudentViewContentChichewa.this, Form1PDFAgriculture.class);
        ...
        buttonAudio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Form1StudentViewContentChichewa.this, Form1AudioAgriculture.class);
                startActivity(intent);
            }
        });
        ...
        buttonVideos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Form1StudentViewContentChichewa.this, Form1VideosAgriculture.class);
                startActivity(intent);
            }
        });
