...
public class Form3QuizPhysics extends AppCompatActivity {

    private TextView questionTextView;
    private RadioButton optionARadioButton, optionBRadioButton, optionCRadioButton, optionDRadioButton;
    private ProgressBar questionProgressBar;
    private List<Form3QuestionPhysics> questions;
    ...
    private List<Form3QuestionPhysics> loadQuestions() {


        List<Form3QuestionPhysics> questions = new ArrayList<>();

        questions.add(new Form3QuestionPhysics("Define the term 'momentum'.",
        ...
        questions.add(new Form3QuestionPhysics("State Newton's first law of motion.",
        ...
        questions.add(new Form3QuestionPhysics("What is the SI unit of electric current?",
                "Ampere (A)",
                "Volt (V)",
                "Ohm (Ω)",
                "Coulomb (C)",
        ...
        questions.add(new Form3QuestionPhysics("State the principle of conservation of energy.",
        ...
        questions.add(new Form3QuestionPhysics("Define refraction of light.",
        ...
        questions.add(new Form3QuestionPhysics("What is the relationship between voltage, current, and resistance in an electrical circuit?",
                "V = IR",
                "I = VR",
                "R = VI",
                "P = VI",
        ...
        questions.add(new Form3QuestionPhysics("State Archimedes' principle.",
        ...
        questions.add(new Form3QuestionPhysics("Explain the term 'wave-particle duality' in quantum physics.",
        ...
        questions.add(new Form3QuestionPhysics("State the universal law of gravitation.",
        ...
        questions.add(new Form3QuestionPhysics("Define nuclear fission.",
        ...
        questions.add(new Form3QuestionPhysics("State the law of reflection of light.",
    ...
    private void displayQuestion() {
        ...
        if (currentQuestionIndex < questions.size()) {
            ...
            Form3QuestionPhysics currentQuestion = questions.get(currentQuestionIndex);
