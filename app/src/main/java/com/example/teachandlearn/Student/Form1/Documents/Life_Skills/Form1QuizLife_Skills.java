...
public class Form1QuizLife_Skills extends AppCompatActivity {

    private TextView questionTextView;
    private RadioButton optionARadioButton, optionBRadioButton, optionCRadioButton, optionDRadioButton;
    private List<Form1QuestionsLife_Skills> questions;
    ...
    private List<Form1QuestionsLife_Skills> loadQuestions() {
        List<Form1QuestionsLife_Skills> questions = new ArrayList<>();

        questions.add(new Form1QuestionsLife_Skills("What is the importance of good hygiene?",
        ...
        questions.add(new Form1QuestionsLife_Skills("How can you manage your time effectively?",
        ...
        questions.add(new Form1QuestionsLife_Skills("Why is it important to respect others?",
                "It is not important",
        ...
        questions.add(new Form1QuestionsLife_Skills("What are the benefits of regular exercise?",
                "It wastes time",
        ...
        questions.add(new Form1QuestionsLife_Skills("How can you handle peer pressure effectively?",
        ...
        questions.add(new Form1QuestionsLife_Skills("Why is it important to have a positive attitude?",
                "It doesn't matter",
        ...
        questions.add(new Form1QuestionsLife_Skills("How can you handle conflicts peacefully?",
                "Use physical force",
                "Yell and shout",
        ...
        questions.add(new Form1QuestionsLife_Skills("What are the advantages of setting goals?",
        ...
        questions.add(new Form1QuestionsLife_Skills("How can you improve your communication skills?",
        ...
        questions.add(new Form1QuestionsLife_Skills("Why is it important to develop problem-solving skills?",
                "To avoid challenges",
    ...
    private void displayQuestion() {
        if (currentQuestionIndex < questions.size()) {
            Form1QuestionsLife_Skills currentQuestion = questions.get(currentQuestionIndex);
