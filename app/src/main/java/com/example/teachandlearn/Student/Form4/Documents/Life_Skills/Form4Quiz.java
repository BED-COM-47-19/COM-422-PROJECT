...
public class Form4Quiz extends AppCompatActivity {
    ...
    private List<Form4Question> loadQuestions() {
        ...
        questions.add(new Form4Question("Define financial literacy and explain its importance in modern society.",
        ...
        questions.add(new Form4Question("Describe the steps involved in conflict resolution and give an example of each.",
        ...
        questions.add(new Form4Question("Explain the concept of time management and discuss strategies for improving time management skills.",
        ...
        questions.add(new Form4Question("Discuss the benefits and challenges of teamwork in achieving common goals.",
        ...
        questions.add(new Form4Question("Explain the concept of environmental conservation and discuss its significance for sustainable development.",
        ...
        questions.add(new Form4Question("Define assertiveness and explain how it differs from aggression and passivity.",
        ...
        questions.add(new Form4Question("Discuss the importance of critical thinking in decision-making and problem-solving.",
        ...
        questions.add(new Form4Question("Explain the concept of civic responsibility and discuss its role in promoting social change.",
        ...
        questions.add(new Form4Question("Discuss the impact of globalization on cultural diversity and identity.",
        ...
        questions.add(new Form4Question("Explain the concept of resilience and discuss its importance in overcoming adversity.",
