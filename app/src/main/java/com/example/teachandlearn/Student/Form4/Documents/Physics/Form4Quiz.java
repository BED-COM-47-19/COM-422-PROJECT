...
public class Form4Quiz extends AppCompatActivity {
    ...
    private List<Form4Question> loadQuestions() {
        ...
        questions.add(new Form4Question("Explain the concept of electric field intensity and its unit of measurement.",
        ...
        questions.add(new Form4Question("Describe the process of electromagnetic induction and its applications.",
        ...
        questions.add(new Form4Question("Explain the principles of reflection and refraction of light.",
        ...
        questions.add(new Form4Question("Discuss the principles behind the functioning of a cathode-ray oscilloscope (CRO).",
        ...
        questions.add(new Form4Question("Explain the concept of nuclear fission and its role in nuclear power generation.",
        ...
        questions.add(new Form4Question("Discuss the concept of interference in the context of wave phenomena.",
        ...
        questions.add(new Form4Question("Explain the concept of electromagnetic waves and their properties.",
        ...
        questions.add(new Form4Question("Discuss the concept of thermal equilibrium and its importance in thermodynamics.",
        ...
        questions.add(new Form4Question("Explain the operation of a transformer and its significance in electrical power transmission.",
        ...
        questions.add(new Form4Question("Explain the concept of mechanical waves and give examples of longitudinal and transverse waves.",
        ...
        questions.add(new Form4Question("Explain the concept of electric current and its unit of measurement.",
