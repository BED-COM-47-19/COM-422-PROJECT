...
public class Form3QuizzesAndQuestionsGeography extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form3QuizzesAndQuestionsGeography.this, Form3PDFViewerGeography.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form3QuizzesAndQuestionsGeography.this, Form3QuizGeography.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form1/humanities/geography/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form3QuizzesAndQuestionsGeography.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
