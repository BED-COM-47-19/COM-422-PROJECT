...
public class Form4QuizzesAndQuestionsPhysics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form4QuizzesAndQuestionsPhysics.this, Form4PDFViewerPhysics.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form4QuizzesAndQuestionsPhysics.this, Form4QuizPhysics.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form4/sciences/physics/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form4QuizzesAndQuestionsPhysics.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
