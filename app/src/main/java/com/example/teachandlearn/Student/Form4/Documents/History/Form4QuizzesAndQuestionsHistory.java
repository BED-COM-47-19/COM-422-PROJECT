...
public class Form4QuizzesAndQuestionsHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form4QuizzesAndQuestionsHistory.this, Form4PDFViewerHistory.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form4QuizzesAndQuestionsHistory.this, Form4QuizHistory.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form4/languages/history/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form4QuizzesAndQuestionsHistory.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
