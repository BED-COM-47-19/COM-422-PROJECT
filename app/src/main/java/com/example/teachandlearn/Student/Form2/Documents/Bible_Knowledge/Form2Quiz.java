...
public class Form2Quiz extends AppCompatActivity {
    ...
    private List<Form2Question> loadQuestions() {
        ...
        questions.add(new Form2Question("Who was the brother of Moses?",
                "Aaron",
                "Elijah",
                "Joshua",
                "David",
        ...
        questions.add(new Form2Question("Which prophet was taken up to heaven in a whirlwind?",
                "Isaiah",
                "Elijah",
                "Jeremiah",
                "Daniel",
        ...
        questions.add(new Form2Question("What is the first book of the New Testament?",
                "Genesis",
                "Exodus",
                "Matthew",
                "Psalms",
        ...
        questions.add(new Form2Question("Who betrayed Jesus to the religious authorities?",
                "Peter",
                "John",
                "Judas Iscariot",
                "Thomas",
        ...
        questions.add(new Form2Question("Who was known for his wisdom and wrote many proverbs in the Bible?",
                "David",
                "Solomon",
                "Samuel",
                "Ezekiel",
        ...
        questions.add(new Form2Question("Which of these is not one of the Ten Commandments?",
        ...
        questions.add(new Form2Question("Who was the first king of Israel?",
                "David",
                "Saul",
                "Solomon",
                "Samuel",
        ...
        questions.add(new Form2Question("Which disciple of Jesus doubted His resurrection until he saw Jesus for himself?",
                "Peter",
                "John",
                "Thomas",
                "James",
        ...
        questions.add(new Form2Question("Who was thrown into a den of lions but saved by God?",
                "Daniel",
                "Joseph",
                "Moses",
                "Samson",
        ...
        questions.add(new Form2Question("Who was sold into slavery by his brothers and later became a ruler in Egypt?",
                "Isaac",
                "Jacob",
                "Joseph",
                "Abraham",
