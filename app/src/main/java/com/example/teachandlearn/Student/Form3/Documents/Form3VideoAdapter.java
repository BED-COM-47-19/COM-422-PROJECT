...
public class Form3VideoAdapter extends RecyclerView.Adapter<Form3VideoAdapter.ViewHolder> {
    private List<DataSnapshot> videoList = new ArrayList<>();
    private LayoutInflater inflater;

    public Form3VideoAdapter(Query query, AppCompatActivity activity) {
