...
public class StudentPasswordReset extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_password_reset);
        ...
        sendCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(StudentPasswordReset.this, "Code sent to your email: " + code, Toast.LENGTH_SHORT).show();
            }
        });
    }
}
