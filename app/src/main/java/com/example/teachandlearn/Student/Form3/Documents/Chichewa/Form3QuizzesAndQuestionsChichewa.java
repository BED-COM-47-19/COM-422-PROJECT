...
public class Form3QuizzesAndQuestionsChichewa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form3QuizzesAndQuestionsChichewa.this, Form3PDFViewerChichewa.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form3QuizzesAndQuestionsChichewa.this, Form3QuizChichewa.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form3/languages/chichewa/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form3QuizzesAndQuestionsChichewa.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
