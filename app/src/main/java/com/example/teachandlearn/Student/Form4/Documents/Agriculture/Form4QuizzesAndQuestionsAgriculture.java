...
public class Form4QuizzesAndQuestionsAgriculture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form4QuizzesAndQuestionsAgriculture.this, Form4PDFViewerAgriculture.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form4QuizzesAndQuestionsAgriculture.this, Form4QuizAgriculture.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form4/sciences/agriculture/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form4QuizzesAndQuestionsAgriculture.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
