...
public class Form3QuizChichewa extends AppCompatActivity {

    private TextView questionTextView;
    private RadioButton optionARadioButton, optionBRadioButton, optionCRadioButton, optionDRadioButton;
    private ProgressBar questionProgressBar;
    private List<Form3QuestionChichewa> questions;
    ...
    private List<Form3QuestionChichewa> loadQuestions() {


        List<Form3QuestionChichewa> questions = new ArrayList<>();
    ...
    private void displayQuestion() {
        ...
        if (currentQuestionIndex < questions.size()) {
            ...
            Form3QuestionChichewa currentQuestion = questions.get(currentQuestionIndex);
