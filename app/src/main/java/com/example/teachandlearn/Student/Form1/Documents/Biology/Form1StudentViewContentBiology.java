...
public class Form1StudentViewContentBiology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonVideos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Form1StudentViewContentBiology.this, Form1VideosAgriculture.class);
                startActivity(intent);
            }
        });
        ...
        buttonQuestions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Form1StudentViewContentBiology.this, Form1QuizzesAndQuestionsGeography.class);
                startActivity(intent);
            }
        });
