...
public class Form2QuizzesAndQuestionsLife_Skills extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form2QuizzesAndQuestionsLife_Skills.this, Form2PDFViewerLife_Skills.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form2QuizzesAndQuestionsLife_Skills.this, Form2QuizLife_Skills.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form2/humanities/life_skills/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form2QuizzesAndQuestionsLife_Skills.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
