...
public class Form3QuizBiology extends AppCompatActivity {

    private TextView questionTextView;
    private RadioButton optionARadioButton, optionBRadioButton, optionCRadioButton, optionDRadioButton;
    private ProgressBar questionProgressBar;
    private List<Form3QuestionBiology> questions;
    ...
    private List<Form3QuestionBiology> loadQuestions() {


        List<Form3QuestionBiology> questions = new ArrayList<>();
        questions.add(new Form3QuestionBiology("What is the function of the mitochondria in a cell?",
        ...
        questions.add(new Form3QuestionBiology("Explain the process of photosynthesis.",
        ...
        questions.add(new Form3QuestionBiology("What is homeostasis and why is it important in living organisms?",
        ...
        questions.add(new Form3QuestionBiology("Describe the structure and function of DNA.",
        ...
        questions.add(new Form3QuestionBiology("What is natural selection and how does it drive evolution?",
        ...
        questions.add(new Form3QuestionBiology("What are enzymes and what role do they play in biochemical reactions?",
        ...
        questions.add(new Form3QuestionBiology("Explain the process of cellular respiration and its importance in living organisms.",
        ...
        questions.add(new Form3QuestionBiology("Describe the difference between mitosis and meiosis.",
        ...
        questions.add(new Form3QuestionBiology("What is the function of the circulatory system in the human body?",
        ...
        questions.add(new Form3QuestionBiology("Discuss the role of hormones in the human body.",
        ...
        questions.add(new Form3QuestionBiology("Explain the process of evolution by natural selection.",
    ...
    private void displayQuestion() {
        ...
        if (currentQuestionIndex < questions.size()) {
            ...
            Form3QuestionBiology currentQuestion = questions.get(currentQuestionIndex);
