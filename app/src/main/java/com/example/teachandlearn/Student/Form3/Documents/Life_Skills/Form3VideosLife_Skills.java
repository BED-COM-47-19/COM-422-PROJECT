...
import com.example.teachandlearn.Student.Form3.Documents.Geography.Form3VideosGeography;
import com.example.teachandlearn.Student.Form3.Documents.Life_Skills.Form3AudioLife_Skills;
...
public class Form3VideosLife_Skills extends AppCompatActivity {
    ...
    private void fetchVideos() {
        ...
        StorageReference storageRef = storage.getReference().child("/form3/humanities/life_skills/videos/");

        storageRef.listAll().addOnSuccessListener(listResult -> {
            List<Form3VideosLife_Skills.VideoItem> videos = new ArrayList<>();
            for (StorageReference item : listResult.getItems()) {
                item.getDownloadUrl().addOnSuccessListener(uri -> {
                    String name = item.getName();
                    String url = uri.toString();
                    videos.add(new Form3VideosLife_Skills.VideoItem(name, url));
