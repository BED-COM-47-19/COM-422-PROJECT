...
package com.example.teachandlearn.Student.Form1.Documents.Chichewa;
...
public class Form1QuizChichewa extends AppCompatActivity {

    private TextView questionTextView;
    private RadioButton optionARadioButton, optionBRadioButton, optionCRadioButton, optionDRadioButton;
    private ProgressBar questionProgressBar;
    private List<Form1QuestionChichewa> form1Questions;
    ...
    private List<Form1QuestionChichewa> loadQuestions() {


        List<Form1QuestionChichewa> form1Questions = new ArrayList<>();
        form1Questions.add(new Form1QuestionChichewa("What is the capital of France?", "Lilongwe", "Paris", "Mzuzu", "Dowa", "Paris"));
        form1Questions.add(new Form1QuestionChichewa("What is 2 + 2?", "1", "5", "3", "4", "4"));
        form1Questions.add(new Form1QuestionChichewa("What is the color of the sky?", "Sky Black", "Sky Green", "Sky White", "Sky Blue", "Sky Blue"));
        form1Questions.add(new Form1QuestionChichewa("What is the capital of Spain?", "Barcelona", "London", "Madrid", "Espana", "Madrid"));
    ...
    private void displayQuestion() {
        ...
        if (currentQuestionIndex < form1Questions.size()) {
            ...
            Form1QuestionChichewa currentForm1Question = form1Questions.get(currentQuestionIndex);
