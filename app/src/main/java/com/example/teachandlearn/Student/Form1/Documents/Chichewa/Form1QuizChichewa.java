...
public class Form1QuizChichewa extends AppCompatActivity {
    ...
    private List<Form1QuestionChichewa> loadQuestions() {
        ...
        form1Questions.add(new Form1QuestionChichewa("Kodi dzina la mtsikana amene anayenda ndi mfumu ndi ndani?", "A Chikondi", "B Chisomo", "C Thoko", "D Rose", "A Chikondi"));
        form1Questions.add(new Form1QuestionChichewa("Kodi mphaka anali ndi mitundu iti?", "A Buluu", "B Wofiira", "C Woyera", "D Wakuda", "C Woyera"));
    ...
    private void finishQuiz() {
        ...
        for (int i = 0; i < form1Questions.size(); i++) {
            Form1QuestionChichewa question = form1Questions.get(i);
