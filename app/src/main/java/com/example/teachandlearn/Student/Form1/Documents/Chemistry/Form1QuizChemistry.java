...
public class Form1QuizChemistry extends AppCompatActivity {
    ...
    private List<Form1QuestionChemistry> loadQuestions() {
        ...
        form1Questions.add(new Form1QuestionChemistry("What is the capital of France?", "Lilongwe", "Paris", "Mzuzu", "Dowa", "Paris"));
        form1Questions.add(new Form1QuestionChemistry("What is 2 + 2?", "1", "5", "3", "4", "4"));
        form1Questions.add(new Form1QuestionChemistry("What is the color of the sky?", "Sky Black", "Sky Green", "Sky White", "Sky Blue", "Sky Blue"));
        form1Questions.add(new Form1QuestionChemistry("What is the capital of Spain?", "Barcelona", "London", "Madrid", "Espana", "Madrid"));
