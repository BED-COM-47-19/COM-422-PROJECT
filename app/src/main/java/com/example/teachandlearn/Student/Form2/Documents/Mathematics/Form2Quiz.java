...
public class Form2Quiz extends AppCompatActivity {
    ...
    private List<Form2Question> loadQuestions() {
        ...
        questions.add(new Form2Question("Solve for x: 3x + 5 = 17",
                "x = 4",
                "x = 6",
                "x = 7",
                "x = 12",
        ...
        questions.add(new Form2Question("Simplify the expression: 3a^2b + 2ab^2 - ab",
                "3a^2b + 2ab^2 - ab",
                "3a^2b + ab^2",
                "3a^2b - ab^2",
                "3a^2b + 3ab^2",
        ...
        questions.add(new Form2Question("Find the value of y if y/5 = 12",
                "y = 60",
                "y = 10",
                "y = 15",
                "y = 7",
        ...
        questions.add(new Form2Question("Calculate the area of a triangle with base 6 cm and height 8 cm",
                "24 sq cm",
                "20 sq cm",
                "30 sq cm",
                "18 sq cm",
        ...
        questions.add(new Form2Question("Simplify: (2x + 5y)^2",
                "4x^2 + 20xy + 25y^2",
                "4x^2 + 10xy + 25y^2",
                "4x^2 + 10xy + 20y^2",
                "4x^2 + 20xy + 20y^2",
        ...
        questions.add(new Form2Question("Solve for x: 2(x - 3) = 10",
                "x = 8",
                "x = 7",
                "x = 6",
                "x = 5",
        ...
        questions.add(new Form2Question("Simplify: (4x^2y^3)^3",
                "64x^6y^9",
                "16x^5y^6",
                "12x^6y^9",
                "16x^6y^9",
        ...
        questions.add(new Form2Question("Calculate the perimeter of a rectangle with length 12 cm and width 8 cm",
                "40 cm",
                "32 cm",
                "24 cm",
                "20 cm",
        ...
        questions.add(new Form2Question("Solve for x: 5(x + 2) = 35",
                "x = 5",
                "x = 6",
                "x = 7",
                "x = 8",
        ...
        questions.add(new Form2Question("Simplify: 2a^3b^2 * 3a^2b^3",
                "6a^5b^5",
                "5a^5b^5",
                "6a^6b^5",
                "5a^6b^5",
