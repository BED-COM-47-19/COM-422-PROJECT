...
public class Form2QuizPhysics extends AppCompatActivity {

    private TextView questionTextView;
    private RadioButton optionARadioButton, optionBRadioButton, optionCRadioButton, optionDRadioButton;
    private ProgressBar questionProgressBar;
    private List<Form2QuestionPhysics> questions;
    ...
    private List<Form2QuestionPhysics> loadQuestions() {


        List<Form2QuestionPhysics> questions = new ArrayList<>();


        questions.add(new Form2QuestionPhysics("What is the SI unit of force?",
                "Newton",
                "Joule",
                "Watt",
                "Volt",
        ...
        questions.add(new Form2QuestionPhysics("Define acceleration.",
        ...
        questions.add(new Form2QuestionPhysics("A car travels at 20 m/s for 30 seconds. What is the distance traveled by the car?",
                "600 meters",
                "400 meters",
                "800 meters",
                "1000 meters",
        ...
        questions.add(new Form2QuestionPhysics("What is the formula for calculating kinetic energy?",
                "KE = 1/2 mv^2",
                "KE = mv",
                "KE = m^2v",
                "KE = 2mv",
        ...
        questions.add(new Form2QuestionPhysics("State the law of conservation of energy.",
        ...
        questions.add(new Form2QuestionPhysics("What is the principle of moments?",
        ...
        questions.add(new Form2QuestionPhysics("What is the relationship between frequency (f), wavelength (λ), and wave speed (v) of a wave?",
                "v = fλ",
                "v = f + λ",
                "v = f/λ",
                "v = f - λ",
        ...
        questions.add(new Form2QuestionPhysics("Define pressure.",
                "Force per unit area",
        ...
        questions.add(new Form2QuestionPhysics("What is the unit of electric current?",
                "Ampere (A)",
                "Volt (V)",
                "Ohm (Ω)",
                "Coulomb (C)",
        ...
        questions.add(new Form2QuestionPhysics("Explain the term 'refraction' of light.",
    ...
    private void displayQuestion() {
        ...
        if (currentQuestionIndex < questions.size()) {
            ...
            Form2QuestionPhysics currentQuestion = questions.get(currentQuestionIndex);
