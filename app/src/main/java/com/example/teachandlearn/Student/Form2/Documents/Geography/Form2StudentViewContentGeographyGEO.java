...
public class Form2StudentViewContentGeographyGEO extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form2_geography_view_content);
        ...
        buttonPDF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Form2StudentViewContentGeographyGEO.this, Form2PDFGeographyGEO.class);
        ...
        buttonAudio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Form2StudentViewContentGeographyGEO.this, Form2AudioGeographyGEO.class);
                startActivity(intent);
            }
        });
        ...
        buttonVideos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Form2StudentViewContentGeographyGEO.this, Form2VideosGeography.class);
                startActivity(intent);
            }
        });
        ...
        buttonQuestions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Form2StudentViewContentGeographyGEO.this, Form2QuizzesAndQuestionsGeographyGEO.class);
                startActivity(intent);
            }
        });
