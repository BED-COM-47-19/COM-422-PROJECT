...
public class Form1EnglishReadNotesActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_form1_english_read_notes);
    ...
    private void navigateBack() {
        ...
        Intent intent = new Intent(this, Form1StudentViewContentEnglish.class);
