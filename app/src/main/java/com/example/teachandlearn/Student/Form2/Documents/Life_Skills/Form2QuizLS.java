...
public class Form2QuizLS extends AppCompatActivity {

    private TextView questionTextView;
    private RadioButton optionARadioButton, optionBRadioButton, optionCRadioButton, optionDRadioButton;
    private ProgressBar questionProgressBar;
    private List<Form2QuestionLS> questions;
    ...
    private List<Form2QuestionLS> loadQuestions() {


        List<Form2QuestionLS> questions = new ArrayList<>();
        questions.add(new Form2QuestionLS("What is the capital of France?", "Lilongwe", "Paris", "Mzuzu", "Dowa", "Paris"));
        questions.add(new Form2QuestionLS("What is 2 + 2?", "1", "5", "3", "4", "4"));
        questions.add(new Form2QuestionLS("What is the color of the sky?", "Sky Black", "Sky Green", "Sky White", "Sky Blue", "Sky Blue"));
        questions.add(new Form2QuestionLS("What is the capital of Spain?", "Barcelona", "London", "Madrid", "Espana", "Madrid"));
    ...
    private void displayQuestion() {
        ...
        if (currentQuestionIndex < questions.size()) {
            ...
            Form2QuestionLS currentQuestion = questions.get(currentQuestionIndex);
