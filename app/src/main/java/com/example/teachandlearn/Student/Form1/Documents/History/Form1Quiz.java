...
public class Form1Quiz extends AppCompatActivity {
    ...
    private List<Form1Question> loadQuestions() {
        ...
        questions.add(new Form1Question("Who was the first President of Malawi?", "Hastings Banda", "Kamuzu Chibambo", "Joyce Banda", "Bakili Muluzi", "Hastings Banda"));
        questions.add(new Form1Question("When did Malawi gain independence from British rule?", "1960", "1961", "1962", "1963", "1964"));
        questions.add(new Form1Question("Which explorer reached Lake Malawi in the 19th century?", "David Livingstone", "Vasco da Gama", "Marco Polo", "Christopher Columbus", "David Livingstone"));
        questions.add(new Form1Question("What was the name of the kingdom that existed in Malawi before British colonization?", "Chewa Kingdom", "Yao Kingdom", "Ngoni Kingdom", "Tumbuka Kingdom", "Chewa Kingdom"));
        questions.add(new Form1Question("Who led the Ngoni people into Malawi during the 19th century?", "Zwangendaba", "Mzilikazi", "Shaka", "Dingane", "Zwangendaba"));
        questions.add(new Form1Question("What was the capital city of Malawi before Lilongwe?", "Zomba", "Blantyre", "Mzuzu", "Mangochi", "Zomba"));
        questions.add(new Form1Question("Which missionary played a significant role in the spread of Christianity in Malawi?", "Robert Laws", "Mary Slessor", "David Livingstone", "Albert Schweitzer", "Robert Laws"));
        questions.add(new Form1Question("What was the primary economic activity in Malawi during the colonial period?", "Tobacco farming", "Cotton weaving", "Gold mining", "Ivory trading", "Tobacco farming"));
        questions.add(new Form1Question("Which political party led Malawi to independence?", "Malawi Congress Party (MCP)", "United Democratic Front (UDF)", "Alliance for Democracy (AFORD)", "People's Party (PP)", "Malawi Congress Party (MCP)"));
        questions.add(new Form1Question("What is the significance of July 6th in Malawi's history?", "Independence Day", "Martyrs' Day", "Republic Day", "Heroes' Day", "Independence Day"));
    ...
    private void finishQuiz() {
        ...
        for (int i = 0; i < questions.size(); i++) {
            Form1Question question = questions.get(i);
