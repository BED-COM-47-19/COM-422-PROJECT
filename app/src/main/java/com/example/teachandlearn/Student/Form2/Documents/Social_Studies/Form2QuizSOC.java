...
public class Form2QuizSOC extends AppCompatActivity {

    private TextView questionTextView;
    private RadioButton optionARadioButton, optionBRadioButton, optionCRadioButton, optionDRadioButton;
    private ProgressBar questionProgressBar;
    private List<Form2QuestionSOC> questions;
    ...
    private List<Form2QuestionSOC> loadQuestions() {


        List<Form2QuestionSOC> questions = new ArrayList<>();
        questions.add(new Form2QuestionSOC("What is the capital of France?", "Lilongwe", "Paris", "Mzuzu", "Dowa", "Paris"));
        questions.add(new Form2QuestionSOC("What is 2 + 2?", "1", "5", "3", "4", "4"));
        questions.add(new Form2QuestionSOC("What is the color of the sky?", "Sky Black", "Sky Green", "Sky White", "Sky Blue", "Sky Blue"));
        questions.add(new Form2QuestionSOC("What is the capital of Spain?", "Barcelona", "London", "Madrid", "Espana", "Madrid"));
    ...
    private void displayQuestion() {
        ...
        if (currentQuestionIndex < questions.size()) {
            ...
            Form2QuestionSOC currentQuestion = questions.get(currentQuestionIndex);
