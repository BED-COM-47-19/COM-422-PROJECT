...
public class Form1QuizzesAndQuestionsSocial_Studies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form1_soc_quizzes_and_questions);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form1QuizzesAndQuestionsSocial_Studies.this, Form1PDFViewerSocial_Studies.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form1QuizzesAndQuestionsSocial_Studies.this, Form1QuizSocial_Studies.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form1/humanities/social_studies/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form1QuizzesAndQuestionsSocial_Studies.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
