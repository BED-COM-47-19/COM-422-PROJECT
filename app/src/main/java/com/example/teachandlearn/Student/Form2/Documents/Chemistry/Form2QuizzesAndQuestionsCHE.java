...
public class Form2QuizzesAndQuestionsCHE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form2QuizzesAndQuestionsCHE.this, Form2PDFViewerCHE.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form2QuizzesAndQuestionsCHE.this, Form2QuizCHE.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form2QuizzesAndQuestionsCHE.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
