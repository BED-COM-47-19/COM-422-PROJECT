...
public class Form2Quiz extends AppCompatActivity {
    ...
    private List<Form2Question> loadQuestions() {
        ...
        questions.add(new Form2Question("Which part of the cell is responsible for energy production?",
                "Nucleus",
                "Mitochondria",
                "Cell membrane",
        ...
        questions.add(new Form2Question("What is the function of the heart in the human body?",
                "To pump blood",
                "To digest food",
        ...
        questions.add(new Form2Question("Which gas do plants absorb during photosynthesis?",
                "Carbon dioxide",
                "Oxygen",
                "Nitrogen",
                "Hydrogen",
        ...
        questions.add(new Form2Question("What is the purpose of the skeleton in vertebrate animals?",
        ...
        questions.add(new Form2Question("Which of the following is a function of the liver?",
                "To pump blood",
                "To filter waste products",
                "To produce insulin",
                "To digest food",
        ...
        questions.add(new Form2Question("What is the process by which plants make their own food using sunlight?",
                "Respiration",
                "Transpiration",
                "Photosynthesis",
                "Pollination",
        ...
        questions.add(new Form2Question("Which part of the flower produces pollen?",
                "Stigma",
                "Petal",
                "Sepal",
                "Anther",
        ...
        questions.add(new Form2Question("What is the function of the nervous system?",
                "To transport oxygen",
        ...
        questions.add(new Form2Question("Which of these is an example of a renewable resource?",
                "Coal",
                "Natural gas",
                "Solar energy",
                "Petroleum",
        ...
        questions.add(new Form2Question("What is the process by which organisms produce offspring similar to themselves?",
                "Fermentation",
                "Fertilization",
                "Mutation",
                "Excretion",
