...
public class Form3Quiz extends AppCompatActivity {
    ...
    private List<Form3Question> loadQuestions() {
        ...
        questions.add(new Form3Question("What are the key components of effective communication?",
        ...
        questions.add(new Form3Question("Discuss the importance of time management in achieving personal goals.",
        ...
        questions.add(new Form3Question("What are the benefits of teamwork in a school or work environment?",
        ...
        questions.add(new Form3Question("Explain the concept of resilience and why it is important.",
        ...
        questions.add(new Form3Question("Discuss the importance of financial literacy for young adults.",
        ...
        questions.add(new Form3Question("What are the characteristics of a healthy relationship?",
        ...
        questions.add(new Form3Question("Discuss the importance of setting and achieving personal goals.",
        ...
        questions.add(new Form3Question("What strategies can individuals use to manage stress effectively?",
        ...
        questions.add(new Form3Question("Discuss the importance of empathy in building positive relationships.",
        ...
        questions.add(new Form3Question("What are the potential consequences of cyberbullying?",
