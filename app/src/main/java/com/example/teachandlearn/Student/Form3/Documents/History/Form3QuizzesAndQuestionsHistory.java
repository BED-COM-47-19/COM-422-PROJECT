...
public class Form3QuizzesAndQuestionsHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form3QuizzesAndQuestionsHistory.this, Form3PDFViewerHistory.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form3QuizzesAndQuestionsHistory.this, Form3QuizHistory.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form3/humanities/history/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form3QuizzesAndQuestionsHistory.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
