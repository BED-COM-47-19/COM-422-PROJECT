...
public class Form2Quiz extends AppCompatActivity {
    ...
    private List<Form2Question> loadQuestions() {
        ...
        questions.add(new Form2Question("Why is it important to set goals in life?",
        ...
        questions.add(new Form2Question("What are the benefits of teamwork?",
        ...
        questions.add(new Form2Question("How can you effectively manage your time?",
        ...
        questions.add(new Form2Question("Why is it important to develop good communication skills?",
                "To isolate oneself",
        ...
        questions.add(new Form2Question("What are the consequences of bullying?",
        ...
        questions.add(new Form2Question("How can you show respect to others?",
        ...
        questions.add(new Form2Question("What are the benefits of staying physically active?",
        ...
        questions.add(new Form2Question("Why is it important to manage money wisely?",
                "To accumulate debt",
        ...
        questions.add(new Form2Question("How can you resolve conflicts peacefully?",
                "By being aggressive",
        ...
        questions.add(new Form2Question("What is the importance of being resilient?",
                "To give up easily",
