...
public class Form3QuizBible_Knowledge extends AppCompatActivity {

    private TextView questionTextView;
    private RadioButton optionARadioButton, optionBRadioButton, optionCRadioButton, optionDRadioButton;
    private ProgressBar questionProgressBar;
    private List<Form3QuestionBible_Knowledge> questions;
    ...
    private List<Form3QuestionBible_Knowledge> loadQuestions() {


        List<Form3QuestionBible_Knowledge> questions = new ArrayList<>();
    ...
    private void displayQuestion() {
        ...
        if (currentQuestionIndex < questions.size()) {
            ...
            Form3QuestionBible_Knowledge currentQuestion = questions.get(currentQuestionIndex);
