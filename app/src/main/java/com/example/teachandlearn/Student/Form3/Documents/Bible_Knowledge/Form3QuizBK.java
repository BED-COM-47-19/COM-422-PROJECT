...
public class Form3QuizBK extends AppCompatActivity {

    private TextView questionTextView;
    private RadioButton optionARadioButton, optionBRadioButton, optionCRadioButton, optionDRadioButton;
    private ProgressBar questionProgressBar;
    private List<Form3QuestionBK> questions;
    ...
    private List<Form3QuestionBK> loadQuestions() {


        List<Form3QuestionBK> questions = new ArrayList<>();
    ...
    private void displayQuestion() {
        ...
        if (currentQuestionIndex < questions.size()) {
            ...
            Form3QuestionBK currentQuestion = questions.get(currentQuestionIndex);
