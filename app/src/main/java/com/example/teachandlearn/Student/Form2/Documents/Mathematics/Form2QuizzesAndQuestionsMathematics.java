...
public class Form2QuizzesAndQuestionsMathematics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form2QuizzesAndQuestionsMathematics.this, Form2PDFViewerMathematics.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form2QuizzesAndQuestionsMathematics.this, Form2QuizMathematics.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form2/sciences/mathematics/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form2QuizzesAndQuestionsMathematics.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
