...
public class Form1QuizBible_Knowledge extends AppCompatActivity {
    ...
    private List<Form1QuestionBible_Knowledge> loadQuestions() {
        ...
        questions.add(new Form1QuestionBible_Knowledge("What is the capital of France?", "Lilongwe", "Paris", "Mzuzu", "Dowa", "Paris"));
        questions.add(new Form1QuestionBible_Knowledge("What is 2 + 2?", "1", "5", "3", "4", "4"));
        questions.add(new Form1QuestionBible_Knowledge("What is the color of the sky?", "Sky Black", "Sky Green", "Sky White", "Sky Blue", "Sky Blue"));
        questions.add(new Form1QuestionBible_Knowledge("What is the capital of Spain?", "Barcelona", "London", "Madrid", "Espana", "Madrid"));
