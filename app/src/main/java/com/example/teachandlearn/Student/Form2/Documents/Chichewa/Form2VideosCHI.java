...
public class Form2VideosCHI extends AppCompatActivity {
            ...
            if (!comment.isEmpty()) {
                ...
                chatGPTService.sendCommentToAI(comment, new ChatGPTService.ChatGPTCallback() {
                    ...
                    public void onSuccess(String response) {
                        ...
                        Toast.makeText(Form2VideosCHI.this, "AI Response: " + response, Toast.LENGTH_LONG).show();
                    }

                    @Override
                    public void onFailure(Throwable t) {
                        // Handle the failure of the AI response
                        Toast.makeText(Form2VideosCHI.this, "Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            } else {
                Toast.makeText(Form2VideosCHI.this, "Please enter a comment", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void fetchVideos() {
        ...
        StorageReference storageRef = storage.getReference().child("/form2/languages/chichewa/videos/");
            ...
            for (StorageReference item : listResult.getItems()) {
                item.getDownloadUrl().addOnSuccessListener(uri -> {
                    ...
                    if (videos.size() == listResult.getItems().size()) {
                        form1VideoAdapter = new Form1VideoAdapter(videos, Form2VideosCHI.this, comments);
