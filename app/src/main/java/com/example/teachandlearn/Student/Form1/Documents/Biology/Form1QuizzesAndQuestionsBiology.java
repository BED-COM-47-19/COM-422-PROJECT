...
public class Form1QuizzesAndQuestionsBiology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form1_bio_quizzes_and_questions);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form1QuizzesAndQuestionsBiology.this, Form1PDFViewerBiology.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form1QuizzesAndQuestionsBiology.this, Form1QuizBiology.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form1/sciences/biology/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form1QuizzesAndQuestionsBiology.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
