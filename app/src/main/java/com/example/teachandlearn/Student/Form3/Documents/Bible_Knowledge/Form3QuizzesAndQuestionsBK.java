...
public class Form3QuizzesAndQuestionsBK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form3QuizzesAndQuestionsBK.this, Form3PDFViewerBK.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form3QuizzesAndQuestionsBK.this, Form3QuizBK.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form3QuizzesAndQuestionsBK.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
