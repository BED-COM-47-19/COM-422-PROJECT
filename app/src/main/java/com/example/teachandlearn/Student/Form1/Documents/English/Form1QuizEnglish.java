...
public class Form1QuizEnglish extends AppCompatActivity {
    ...
    private List<Form1QuestionEnglish> loadQuestions() {
        ...
        form1Questions.add(new Form1QuestionEnglish("What is the capital of France?", "Lilongwe", "Paris", "Mzuzu", "Dowa", "Paris"));
        form1Questions.add(new Form1QuestionEnglish("What is 2 + 2?", "1", "5", "3", "4", "4"));
        form1Questions.add(new Form1QuestionEnglish("What is the color of the sky?", "Sky Black", "Sky Green", "Sky White", "Sky Blue", "Sky Blue"));
        form1Questions.add(new Form1QuestionEnglish("What is the capital of Spain?", "Barcelona", "London", "Madrid", "Espana", "Madrid"));
