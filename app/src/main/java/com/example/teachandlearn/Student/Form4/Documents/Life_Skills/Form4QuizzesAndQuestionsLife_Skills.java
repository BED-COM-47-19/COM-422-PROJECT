...
public class Form4QuizzesAndQuestionsLife_Skills extends AppCompatActivity {
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form4/humanities/life_skills/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form4QuizzesAndQuestionsLife_Skills.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
