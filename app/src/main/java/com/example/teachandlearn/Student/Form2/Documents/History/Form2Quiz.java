...
public class Form2Quiz extends AppCompatActivity {
    ...
    private List<Form2Question> loadQuestions() {
        ...
        questions.add(new Form2Question("Which European countries were heavily involved in the transatlantic slave trade in Central Africa?",
                "Portugal and Spain",
                "England and France",
        ...
        questions.add(new Form2Question("Who were the main victims of the transatlantic slave trade from Central Africa?",
                "Arab traders",
                "European explorers",
                "Local chiefs",
        ...
        questions.add(new Form2Question("Which famous missionary explored Central Africa and opposed the slave trade?",
                "David Livingstone",
                "Mary Slessor",
                "Robert Moffat",
                "Albert Schweitzer",
        ...
        questions.add(new Form2Question("What was the impact of European missionaries in Central Africa during the colonial period?",
        ...
        questions.add(new Form2Question("Which Central African kingdom resisted European colonization the longest?",
                "Ashanti Empire",
                "Kingdom of Kongo",
                "Oyo Empire",
                "Buganda Kingdom",
        ...
        questions.add(new Form2Question("What was the Berlin Conference of 1884-1885 about in relation to Central Africa?",
        ...
        questions.add(new Form2Question("Who was the leader of the Maji Maji Rebellion in German East Africa (Tanzania) against colonial rule?",
                "Jomo Kenyatta",
                "Julius Nyerere",
                "Sekou Toure",
                "Kinjikitile Ngwale",
        ...
        questions.add(new Form2Question("Which Central African country was the first to gain independence from European colonial rule?",
                "Ghana",
                "Kenya",
                "Nigeria",
        ...
        questions.add(new Form2Question("What was the main economic activity in Central Africa during the colonial period?",
                "Cotton farming",
                "Gold mining",
                "Diamond mining",
                "Rubber production",
        ...
        questions.add(new Form2Question("Which European explorer first reached the Congo River and explored Central Africa extensively?",
