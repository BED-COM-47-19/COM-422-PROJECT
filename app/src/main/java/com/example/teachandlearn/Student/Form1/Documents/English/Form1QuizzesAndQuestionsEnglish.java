...
public class Form1QuizzesAndQuestionsEnglish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form1_eng_quizzes_and_questions);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form1QuizzesAndQuestionsEnglish.this, Form1PDFViewerEnglish.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form1QuizzesAndQuestionsEnglish.this, Form1QuizEnglish.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form1/languages/english/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form1QuizzesAndQuestionsEnglish.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
