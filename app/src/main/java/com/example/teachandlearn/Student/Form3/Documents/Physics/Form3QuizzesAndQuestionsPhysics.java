...
public class Form3QuizzesAndQuestionsPhysics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form3QuizzesAndQuestionsPhysics.this, Form3PDFViewerPhysics.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form3QuizzesAndQuestionsPhysics.this, Form3QuizPhysics.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form3/sciences/physics/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form3QuizzesAndQuestionsPhysics.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
