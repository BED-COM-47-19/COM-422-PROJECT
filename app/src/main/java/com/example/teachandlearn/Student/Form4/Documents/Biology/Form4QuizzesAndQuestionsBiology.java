...
public class Form4QuizzesAndQuestionsBiology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form4QuizzesAndQuestionsBiology.this, Form4PDFViewerBiology.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form4QuizzesAndQuestionsBiology.this, Form4QuizBiology.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form4/sciences/biology/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form4QuizzesAndQuestionsBiology.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
