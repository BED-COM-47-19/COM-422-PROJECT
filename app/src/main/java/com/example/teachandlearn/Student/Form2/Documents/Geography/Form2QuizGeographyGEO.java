...
public class Form2QuizGeographyGEO extends AppCompatActivity {

    private TextView questionTextView;
    private RadioButton optionARadioButton, optionBRadioButton, optionCRadioButton, optionDRadioButton;
    private ProgressBar questionProgressBar;
    private List<Form2QuestionGeographyGEO> questions;
    ...
    private List<Form2QuestionGeographyGEO> loadQuestions() {


        List<Form2QuestionGeographyGEO> questions = new ArrayList<>();
        questions.add(new Form2QuestionGeographyGEO("What is the capital of France?", "Lilongwe", "Paris", "Mzuzu", "Dowa", "Paris"));
        questions.add(new Form2QuestionGeographyGEO("What is 2 + 2?", "1", "5", "3", "4", "4"));
        questions.add(new Form2QuestionGeographyGEO("What is the color of the sky?", "Sky Black", "Sky Green", "Sky White", "Sky Blue", "Sky Blue"));
        questions.add(new Form2QuestionGeographyGEO("What is the capital of Spain?", "Barcelona", "London", "Madrid", "Espana", "Madrid"));
    ...
    private void displayQuestion() {
        ...
        if (currentQuestionIndex < questions.size()) {
            ...
            Form2QuestionGeographyGEO currentQuestion = questions.get(currentQuestionIndex);
