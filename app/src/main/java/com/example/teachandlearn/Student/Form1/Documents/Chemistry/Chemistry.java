...
public class Chemistry extends AppCompatActivity {
            ...
            if (!comment.isEmpty()) {
                ...
                chatGPTService.sendCommentToAI(comment, new ChatGPTService.ChatGPTCallback() {
                    ...
                    public void onSuccess(String response) {
                        ...
                        Toast.makeText(Chemistry.this, "AI Response: " + response, Toast.LENGTH_LONG).show();
                    }

                    @Override
                    public void onFailure(Throwable t) {
                        // Handle the failure of the AI response
                        Toast.makeText(Chemistry.this, "Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            } else {
                Toast.makeText(Chemistry.this, "Please enter a comment", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void fetchVideos() {
        ...
        StorageReference storageRef = storage.getReference().child("/form1/sciences/chemistry/videos/");
            ...
            for (StorageReference item : listResult.getItems()) {
                item.getDownloadUrl().addOnSuccessListener(uri -> {
                    ...
                    if (videos.size() == listResult.getItems().size()) {
                        form1VideoAdapter = new Form1VideoAdapter(videos, Chemistry.this, comments);
