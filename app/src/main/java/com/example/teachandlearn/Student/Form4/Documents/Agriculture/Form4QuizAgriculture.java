...
public class Form4QuizAgriculture extends AppCompatActivity {

    private TextView questionTextView;
    private RadioButton optionARadioButton, optionBRadioButton, optionCRadioButton, optionDRadioButton;
    private ProgressBar questionProgressBar;
    private List<Form4QuestionAgriculture> questions;
    ...
    private List<Form4QuestionAgriculture> loadQuestions() {


        List<Form4QuestionAgriculture> questions = new ArrayList<>();
        questions.add(new Form4QuestionAgriculture("What is crop rotation?",
        ...
        questions.add(new Form4QuestionAgriculture("What are the benefits of using organic fertilizers over chemical fertilizers?",
        ...
        questions.add(new Form4QuestionAgriculture("Explain integrated pest management (IPM).",
        ...
        questions.add(new Form4QuestionAgriculture("What is the importance of soil pH in agriculture?",
        ...
        questions.add(new Form4QuestionAgriculture("Describe the process of selective breeding in livestock.",
        ...
        questions.add(new Form4QuestionAgriculture("What are leguminous crops, and why are they important in agriculture?",
        ...
        questions.add(new Form4QuestionAgriculture("What is the role of irrigation in crop production?",
        ...
        questions.add(new Form4QuestionAgriculture("Explain the concept of sustainable agriculture.",
        ...
        questions.add(new Form4QuestionAgriculture("What are cover crops, and how do they benefit soil health?",
        ...
        questions.add(new Form4QuestionAgriculture("What is agroforestry, and what are its benefits?",
    ...
    private void displayQuestion() {
        ...
        if (currentQuestionIndex < questions.size()) {
            ...
            Form4QuestionAgriculture currentQuestion = questions.get(currentQuestionIndex);
