...
public class Form1QuizzesAndQuestionsPhysics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form1_phy_quizzes_and_questions);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Form1QuizzesAndQuestionsPhysics.this, Form1PDFViewerPhysics.class);
        ...
        buttonStartQuiz.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Form1QuizzesAndQuestionsPhysics.this, Form1QuizPhysics.class);
    ...
    private void loadPDFsFromStorage() {
        ...
        storageRef = storage.getReference().child("/form1/sciences/physics/quizzes_and_questions/");
        ...
        storageRef.listAll().addOnSuccessListener(listResult -> {
            ...
            // Handle the error
            Toast.makeText(Form1QuizzesAndQuestionsPhysics.this, "Failed to load past papers", Toast.LENGTH_SHORT).show();
        });
