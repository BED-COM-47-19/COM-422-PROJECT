...
public class Form1ScienceActivity extends AppCompatActivity {
    ...
    private void showToast(String message) {
        Toast.makeText(Form1ScienceActivity.this, message, Toast.LENGTH_SHORT).show();
    }

    // Method to start Form1ViewContentActivity
    private void startActivityForContent() {
        Intent intent = new Intent(Form1ScienceActivity.this, Form1ViewContentActivity.class);
