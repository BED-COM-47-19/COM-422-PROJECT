...
public class Form1LanguagesActivity extends AppCompatActivity {
    ...
    private void showToast(String message) {
        Toast.makeText(Form1LanguagesActivity.this, message, Toast.LENGTH_SHORT).show();
    }

    // Method to start Form1ViewContentActivity
    private void startActivityForContent() {
        Intent intent = new Intent(Form1LanguagesActivity.this, Form1ViewContentActivity.class);
